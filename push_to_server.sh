...
scp -r static translations templates models requirements.txt gunicorn.conf.py cleanup_sessions.py app_uts.py app_report_exporter.py app_similarity_controller.py app.py db_api.py models.py forms.py  silhada2@webhost-gpu.fsv.cvut.cz:~/aibal.fsv.cvut.cz/app
