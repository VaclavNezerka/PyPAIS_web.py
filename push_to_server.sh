...
scp -r static translations templates models requirements.txt app_report_exporter.py app_similarity_controller.py app.py db_api.py models.py forms.py silhada2@webhost-03.fsv.cvut.cz:~/aibal.fsv.cvut.cz/app